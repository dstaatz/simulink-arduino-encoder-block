classdef EncoderRead < realtime.internal.SourceSampleTime ...
    ...
    methods
        % Constructor
        function obj = EncoderRead(varargin)
    ...
    methods (Access=protected)
        ...
        function ticks = stepImpl(obj)   %#ok<MANU>
            ticks = int32(0);
            if isempty(coder.target)
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, context)
            if context.isCodeGenTarget('rtw')
                ...
                addSourceFiles(buildInfo, 'encoder_arduino.cpp', srcDir);
